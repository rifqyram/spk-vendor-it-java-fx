...
public class TableUtil {
        ...
        return new TableCell<>() {
            ...
            protected void updateItem(Void item, boolean empty) {
                ...
                if (empty) {
                    ...
                    if (getTableView().getItems().get(getIndex()) instanceof Stock stock) {
                        setGraphic(!stock.getTransactionDetails().isEmpty() ? null : pane);
                        return;
                    }
                    setGraphic(pane);
    ...
    public static TableCell<Product, Long> formatCurrencyIDR() {
        return new TableCell<>() {
            @Override
            protected void updateItem(Long item, boolean empty) {
                ...
                if (empty) {
                    ...
                    String number = CurrencyUtil.formatCurrencyIDR(item);
                    setText(number);
                }
            }
        };
